  ...
  <div class="cards">
    <div class="cards-container grid grid-cols-12 wrap align--start">
      <template v-for="loop in listLoops" :key="loop + '-0'">
        <div class="flex col-span-12 sm:col-span-6 md:col-span-6">
          <va-card>
        ...
        <div class="flex col-span-12 sm:col-span-6 md:col-span-3 xl:col-span-3 lg:col-span-3 xl:col-span-3">
          <va-card>
