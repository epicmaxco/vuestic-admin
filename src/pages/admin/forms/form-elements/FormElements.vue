    ...
    <div class="grid grid-cols-12 gap-6">
      ...
      <va-card class="col-span-12">
        ...
        <va-card-content>
          <form>
            <div class="grid grid-cols-12 gap-6">
              <fieldset class="md:col-span-6 col-span-12 grid grid-cols-3">
                ...
                <va-checkbox v-model="checkbox.readonly" :label="t('forms.controls.readonly')" readonly class="mb-2" />
                <va-checkbox v-model="checkbox.disabled" :label="t('forms.controls.disabled')" disabled class="mb-2" />
