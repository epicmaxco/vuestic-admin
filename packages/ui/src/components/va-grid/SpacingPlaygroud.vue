...
<script>
import VuesticSimpleSelect from '../../../../admin/src/vuestic-theme/vuestic-components/vuestic-simple-select/VuesticSimpleSelect'
import VuesticColorPresentation from '../../../../admin/src/vuestic-theme/vuestic-components/vuestic-color-presentation/VuesticColorPresentation'
